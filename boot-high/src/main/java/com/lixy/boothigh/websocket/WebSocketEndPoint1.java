...
/**
 * @Author: MR LIS
 * @Description:websocket的
 * @Date: Create in 16:23 2018/6/20
 * @Modified By:
 */
@Component
//@ServerEndpoint("/webSocket")
public class WebSocketEndPoint1 {
    private final static Logger logger = LoggerFactory.getLogger(WebSocketEndPoint1.class);

    private Session session;

    private static CopyOnWriteArraySet<WebSocketEndPoint1> webSocketSet = new CopyOnWriteArraySet<>();
    ...
    public void sendMessage(String message) {
        for (WebSocketEndPoint1 webSocket: webSocketSet) {
